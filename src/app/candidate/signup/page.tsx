    ...
    try {
      ...
      const { data, error: signupError } = await supabase.auth.signUp({
        ...
        options: {
          ...
          emailRedirectTo: `${process.env.NEXT_PUBLIC_SITE_URL}/candidate/onboarding`,
        },
      })
    ...
    <div className="min-h-screen bg-[#F1F2F6] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-md p-8">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-[#0D1B2A] mb-4">Candidate Signup</h2>
          <p className="text-[#333333] text-sm">Join our talent network and find your next opportunity</p>
        </div>
